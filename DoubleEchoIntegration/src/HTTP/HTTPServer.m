...
{
    NSLog(@"stopReceivingForFileHandle");
	if (closeFileHandle)
	{
...
{
    NSLog(@"reveiving incoming connection notification");
...
{
    NSLog(@"receiving incoming data notification");
	...
	if(CFHTTPMessageIsHeaderComplete(incomingRequest))
	{
        ...
        NSLog(@"message header incomplete");
